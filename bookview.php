  ...
  <div class="main">
    <div class="navbar-side" class="noPrint">
      ...
      <ul>
        ...
        <li>
          <a href="#" class="myBtn link-text" data-toggle="collapse" data-target="#usr" title="Post" aria-expanded="false">
          ...
          <div id="usr" class="collapse bg-secondary">
            ...
            <a href="#" title="Add Post" class="link-text">
	     ...
	     <li>
          <a href="#" class="myBtn link-active" data-toggle="collapse" data-target="#book" title="Post" aria-expanded="false">
            <span class="icon"><i class="fas fa-book-reader"></i></span>
          ...
          <div id="book" class="collapse bg-secondary">
            ...
            <a href="#" class="myBtn link-active" title="Add Post">
			...
			<div class="content-box-large" >
                ...
                <th>Language</th>
						...
						<?php
								...
								echo "<tbody>";
							    echo "<tr>";
								echo "<td>".$row['acs_no']."</td>";
								echo "<td>".$row['b_name']."</td>";
								echo "<td>".$row['b_auth']."</td>";
								echo "<td>".$row['b_cls']."</td>";
                echo "<td>".$row['b_page']."</td>";
								echo "<td>".$row['isbn']."</td>";
								echo "<td>".$row['b_edi']."</td>";
								echo "<td>".$row['b_vol']."</td>";
                 echo "<td>".$row['b_lang']."</td>";
								echo "<td>".$row['bar_no']."</td>";
