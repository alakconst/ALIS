	  ...
	  <br><br>
			...
			<div class="content-box-large" >
  				<div class="panel-heading">
					<div class="panel-title">Frequency List</div>
				</div>
  				<div class="panel-body" >
  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="userdata">
						...
						<?php
                                ...
                                echo "<td>".$row['m_phn']."</td>";
                                echo "<td>".$row['desn']."</td>";
                                echo "<td>".$row['m_valid']."</td>";
                                echo "<td>".$row['m_qual']."</td>";
                                echo "<td>".$row['m_doe']."</td>";
                                echo "<td>".$row['m_mail']."</td>";
                                echo "<td>".$row['m_d_amt']."</td>";
                                echo "<td>".$row['m_addr']."</td>";
                                echo "<td>".$row['m_rid']."</td>";
                                echo "<td>".$row['rid_no']."</td>";                                           
								echo "</tr>";
								echo "</tbody>";
								}
							//close connection
