    ...
    <div class="navbar-side">
      ...
      <ul>
        ...
        <li>
	     ...
	     <li>
          <a href="#" class="link-active" data-toggle="collapse" data-target="#book" title="Post" aria-expanded="false">
          ...
          <div id="book" class="collapse bg-secondary">
            ...
            <a href="stockTransaction.php" class="mybtn link-active" title="Add Post">
           ...
           <div class="col-md-10">
            <div class="card border-primary rounded-0">
              ...
              <div class="card-body">
                ...
                <a class="btn btn-primary btn-lg btn-block" href="stockview.php" role="button">Stock Details</a>
                <br>
                <br>
                <a class="btn btn-primary btn-lg btn-block" href="bookview.php" role="button">Book details</a>
                <br>
                <br>
                <a class="btn btn-primary btn-lg btn-block" href="frequencyView.php" role="button">Frequency details</a>
                </div>					
              </div>
            </div>
          </div>      
