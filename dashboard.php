    ...
    <div class="content">
	  ...
	  <br>
          ...
          <div class="col-md-10">
			...
			<div class="card-header bg-secondary rounded-0">
                <h5 class="card-title text-white mb-1">Analytical Details</h5>
              </div>
              <div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title">Book Details in Statistic</div>					
	  ...
	  <div class="row">
           <div class="col-md-10">
            <div class="card border-primary rounded-0">
              <div class="card-header bg-secondary rounded-0">
                <h5 class="card-title text-white mb-1">About Automated Library Information System</h5>
              </div>
              <div class="card-body">
                <div class="panel-title ">A library management system is software that is designed to manage all the functions of a library. It helps librarian to maintain the database of new books and the books that are borrowed by members along with their due dates.
...
Management information systems or MIS reports related to the library allow the librarians to extract crucial data & information of all the library transactions at a few clicks.</div>					
              </div>
            </div>
          </div>      
        </div>
